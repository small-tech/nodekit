      ...
      // if (Files.HTTP_METHODS.includes(extension)) {
        filesOfType.forEach(async filePath => {
          ...
          const route = filePath
            ...
            if (extension === 'socket') {
              console.warn('[FILES] ⚠️ Ignoring WebSocket route for now.', filePath)
              return
            }
            ...
            if (handlerRaw.render) {
              ...
              const routePathFragments = routeCache.routeRelativePath.split('/')
              console.log('route relative path', routePathFragments)
              let className = routePathFragments[routePathFragments.length - 2]
              ...
              handler = async (request, response) => {
                ...
                if (routeCache.nodeScript) {
                  ...
                  console.log('Dynamic module', dynamicModule)
                  console.log('relative path to dynamic module', relativePathToDynamicModule)
                ...
                console.log(nodeScript.toString())
            ...
            console.log('[FILES] Adding route to server', httpMethod, route, filePath, handler)
