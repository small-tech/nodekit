...
export default class Files {
  ...
  //
  // TODO: Left off here. For this to work, we have to implement the loader.
  //
  async createRoutes () {
      ...
      if (Files.HTTP_METHODS.includes(extension)) {
        filesOfType.forEach(async filePath => {
          ...
          const route = filePath
            ...
            .replace('_', '/')              // Replace underscores with slashes.
            .replace(/\[(.*?)\]/g, ':$1')   // Replace properties. e.g., [prop] becomes :prop

          this.app[extension.toUpperCase()](route, (await import(filePath)).default)
        })
      }
    })
