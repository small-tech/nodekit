      ...
      plugins: [
        ...
        sveltePlugin(route),
        {
          ...
          setup(build) {
            ...
            build.onEnd(result => {
              console.log('[HYDRATION SCRIPT COMPILER] Build.onEnd. Result =', result)
              // Implement the check parent component before accessing root fix to enable
              // components that cannot be server-side rendered to be instantiated using
              // <svelte:component>
              // Based on PR: https://github.com/sveltejs/svelte/pull/6646/files
